...
<hr />
        ...
        <table 
            style="font-family: 'Times New Roman', Times, serif; font-size: large; background-repeat: repeat; background-attachment: scroll; background-position: center center">
        ...
        <tr>
        <td align="center">
        <p><a href='temp.php'>REGISTER</a> HERE.</p>
        </td>
        </tr>
        </table>
        <hr />
